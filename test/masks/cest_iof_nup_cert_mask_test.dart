...
void main() {
  ...
  group('NupMask', () {
    ...
    test('vazio', () => expect(_fmt(mask, ''), ''));
    test('7 dígitos (sem traço)',
        () => expect(_fmt(mask, '1234567'), '1234567'));
    ...
    test(
        'completo 20',
        () => expect(
            _fmt(mask, '12345678901234567890'), '1234567-89.0123.4.56.7890'));
    test(
        'trunca em 20',
        () => expect(
            _fmt(mask, '123456789012345678901'), '1234567-89.0123.4.56.7890'));
    test(
        'já mascarado',
        () => expect(_fmt(mask, '1234567-89.0123.4.56.7890'),
  ...
  group('CertNascimentoMask', () {
    ...
    test(
        '20 dígitos (grupo 6)',
        () => expect(
            _fmt(mask, '00000011223333455555'), '000000 11 22 3333 4 55555'));
    test(
        '23 dígitos (grupo 7)',
        () => expect(_fmt(mask, '00000011223333455555666'),
            '000000 11 22 3333 4 55555 666'));
    test(
        '30 dígitos (grupo 8)',
